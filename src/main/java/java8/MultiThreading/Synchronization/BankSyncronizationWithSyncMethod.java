...
public class BankSyncronizationWithSyncMethod {

	private double balance;
	
	public BankSyncronizationWithSyncMethod(double balance)
	{
	...
	public synchronized void syncDeposit(double amount) // adding synchronized to fix the RACE issue
	{
		double newBalance = 0;
		if(balance >0)
		{
	...
	public synchronized void syncWithdraw(double amount) // adding synchronized to fix the RACE issue
	{
		double newBalance = 0;
		if(balance >= amount)
		{
	...
	public static void main(String[] args) {
		...
		BankSyncronizationWithSyncMethod bankSyncronization = new BankSyncronizationWithSyncMethod(100);
		...
		System.out.println("********************* using Synchronization Method *******************\n");
		/*
